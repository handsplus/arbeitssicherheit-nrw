...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${BASE}/leistungen`, lastModified: now, changeFrequency: "weekly", priority: 0.95 },
    { url: `${BASE}/leistungen/arbeitssicherheit`, lastModified: now, changeFrequency: "weekly", priority: 0.95 },
    { url: `${BASE}/leistungen/brandschutz`, lastModified: now, changeFrequency: "weekly", priority: 0.95 },
    { url: `${BASE}/leistungen/sigeko`, lastModified: now, changeFrequency: "weekly", priority: 0.95 },
    { url: `${BASE}/leistungen/schulungen`, lastModified: now, changeFrequency: "monthly", priority: 0.85 },
    { url: `${BASE}/leistungen/elektrosicherheit`, lastModified: now, changeFrequency: "monthly", priority: 0.85 },
